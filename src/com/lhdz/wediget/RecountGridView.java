...
public class RecountGridView extends GridView {
	public RecountGridView(Context context) {
		super(context);
	}

	public RecountGridView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public RecountGridView(Context context, AttributeSet attrs, int defStyle) {
