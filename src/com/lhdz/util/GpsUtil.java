...
public class GpsUtil {
	...
	public GpsUtil(Context context) {
		...
		// mLocationClient = new LocationClient(context); // 声明LocationClien
		// mLocationClient.registerLocationListener(myListener);// 注册监听函数
		// setLocationOption();// 设置相应的数据
		mLocationClient.start();// 开始定位
		getCityDataUtil = new GetCityDataUtil(context);
	}
	...
	public class MyLocationListener implements BDLocationListener {
		...
		public void onReceiveLocation(BDLocation location) {
			...
			if (location.getLocType() == BDLocation.TypeNetWorkLocation) {
				...
				int cityId = getCityDataUtil.addrToAreaId(cityAddr);
				if (onReceiveLandMark != null) {
					onReceiveLandMark.onGetLandMark(cityAddr, cityId);
				}
//				MyApplication.stcliyLocation = cityAddr;
//				MyApplication.iCityLocationId = getCityDataUtil.addrToAreaId(cityAddr);
				LogUtils.i("cityCode = " +cityCode);
				LogUtils.i("cityId = " +cityId);
				LogUtils.i("onReceiveLocation " + cityAddr);
			}
		}
	...
	public String location = cityAddr;

	public void setLandMark(GetReceiveLandMark getReceiveLaMark) {
		this.onReceiveLandMark = getReceiveLaMark;
	}
