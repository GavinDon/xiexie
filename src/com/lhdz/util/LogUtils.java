...
public class LogUtils {
    ...
    public static String customTagPrefix = "lhdz"; // 自定义Tag的前�?��可以是作者名
    private static final boolean isSaveLog = true; // 是否把保存日志到SD卡中
//    public static final String ROOT = Environment.getExternalStorageDirectory().getPath() + "/lhdz/"; // SD卡中的根目录
    public static final String ROOT = UniversalUtils.getSDPath() + Define.PATH_TEST_LOG; // SD卡中的根目录
    private static final String PATH_LOG_INFO = ROOT;

    private LogUtils() {
    }

    // 容许打印日志的类型，默认是true，设置为false则不打印
    public static boolean allowD = Config.isDebug;
    public static boolean allowE = Config.isDebug;
    public static boolean allowI = Config.isDebug;
    public static boolean allowV = Config.isDebug;
    public static boolean allowW = Config.isDebug;
    public static boolean allowWtf = Config.isDebug;

    private static String generateTag(StackTraceElement caller) {
        String tag = "%s.%s(Line:%d)"; // 占位�?
        String callerClazzName = caller.getClassName(); // 获取到类�?
